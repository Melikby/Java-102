...
public class AccountManager {
    ...
    public AccountManager() {
        ...
        accounts.add(new Enterprise(new User("Ali","Demir","ademir@gmail.com","123","Software",23)));
        accounts.add(new Individual(new User("Mert","Demir","mdemir@gmail.com","321","Software",17)));
        accounts.add(new Individual(new User("Melik","Boyu","mboyu@gmail.com","333","Software",21)));
    }
